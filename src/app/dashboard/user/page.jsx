    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                {/* Cover Image */}
                <div className="bg-blue-50 h-32 md:h-40 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                <Link href="/allTickets">
                    <div className="bg-white border border-gray-200 rounded-xl p-6 text-center hover:shadow-md transition cursor-pointer hover:border-blue-400">
                        ...
                        <h3 className="font-semibold text-gray-800">Browse Tickets</h3>
                        <p className="text-sm text-gray-500">Find your next journey</p>
                    </div>
                </Link>
